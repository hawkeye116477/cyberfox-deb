...
# Cyberfox launcher (created based on Firefox launcher) containing a Profile migration 
# helper for temporary profiles used during alpha and beta phases.
...
# Cyberfox launcher:
#  8pecxstudios  <support@8pecxstudios.com>
